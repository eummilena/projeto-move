              ...
              <div className={styles.pontilhados}>
               ...
               <div className={styles.box4}>
                  ...
                  <Text className={styles.textBold} text="4. Pague somente após a mudança." />
                    <Text text="APague somente após nossos funcionários concluírem toda mudança de seus pertences em sua nova." />
              </div>
              
      </div>
      <Button text='Faça um orçamento online' className={styles.button} />
    </section>
  )
}
